...
const SECTIONS: Section[] = [
  ...
  // ============= LEARN ABOUT PAGE =============
  {
    ...
    fields: [
      ...
      { key: "hero.description.bn", label: "📝 Description (BN)", type: "textarea", fallback: "Astropixel-এর নিজস্ব লার্নিং প্ল্যাটফর্ম — যেখানে ডিজাইন, ডেভেলপমেন্ট, ফটোগ্রাফি ও ডিজিটাল ক্রিয়েটিভ স্কিল শেখানো হয় প্র্যাকটিকাল ও প্রফেশনাল উপায়ে।" },
      { key: "hero.description.en", label: "📝 Description (EN)", type: "textarea", fallback: "Astropixel's very own learning platform — teaching design, development, photography, and digital creative skills the practical, professional way." },
    ],
  },
  {
    id: "labout-mission",
    ...
    fields: [
      ...
      { key: "mission.desc.bn", label: "📝 Description (BN)", type: "textarea", fallback: "Learn with Astropixel হলো Astropixel এজেন্সির লার্নিং শাখা।" },
      { key: "mission.desc.en", label: "📝 Description (EN)", type: "textarea", fallback: "Learn with Astropixel is the education arm of the Astropixel agency." },
      { key: "mission.whyTitle.bn", label: "✅ Why Heading (BN)", fallback: "কেন Learn with Astropixel?" },
      { key: "mission.whyTitle.en", label: "✅ Why Heading (EN)", fallback: "Why Learn with Astropixel?" },
    ],
  },
  {
    id: "labout-features",
  ...
  },
  {
    ...
    fields: [
      ...
      { key: "lcta.desc.bn", label: "📝 Description (BN)", type: "textarea", fallback: "Astropixel এর সাথে শিখুন, তৈরি করুন এবং আপনার ক্যারিয়ার এগিয়ে নিন।" },
      { key: "lcta.desc.en", label: "📝 Description (EN)", type: "textarea", fallback: "Learn with Astropixel, build real work, and grow your career." },
