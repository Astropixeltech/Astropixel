        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="mt-12 py-7 border-t border-b border-background/10 grid grid-cols-1 sm:grid-cols-3 gap-8 max-w-3xl mx-auto items-center text-center justify-center">
            ...
            <div className="flex flex-col items-center justify-center gap-1.5 group cursor-pointer">
              ...
              <span className="text-xs font-medium text-background/50 tracking-wider uppercase flex items-center gap-1.5">
