...
const logo = (logoFullPng as any)?.src || logoFullPng || logoAsset.url;
      ...
      <div className="container mx-auto px-6 sm:px-8 pt-14 sm:pt-20 pb-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-10 lg:gap-12">
            {/* Brand */}
            <div className="col-span-2 sm:col-span-1 lg:pr-6">
              ...
              <p className="text-xs sm:text-sm leading-relaxed text-background/60 max-w-xs">
                {description}
              </p>
            </div>
            ...
            <div className="col-span-2 sm:col-span-1">
              ...
              <div className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm font-medium text-background/70">
                <p>{address}</p>
                <a
                  href={`mailto:${email}`}
                  ...
                  {displaySocialLinks.map((item: any, idx: number) => {
                    ...
                    return (
                      <a
                        ...
                        className="w-7 h-7 sm:w-8 sm:h-8 rounded-full border border-background/20 flex items-center justify-center text-background/70 hover:text-background hover:border-background/60 hover:scale-105 transition-all duration-300"
                      >
                        <Icon size={14} />
                      </a>
                    );
          ...
          <div className="mt-10 py-6 border-t border-b border-background/10 grid grid-cols-2 sm:grid-cols-4 gap-4 max-w-4xl mx-auto items-center text-center justify-center">
            ...
            >
              <div className="flex items-center gap-1.5 font-bold text-sm sm:text-base tracking-tight group-hover:scale-105 transition-transform">
